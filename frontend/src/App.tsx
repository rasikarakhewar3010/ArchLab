/**
 * App — Root Application Component (Phase 2 Enhanced)
 * =====================================================
 * Wires together the Header, Canvas, Sidebar, and Simulation Panel.
 * Uses the useSimulation hook to manage the simulation lifecycle.
 *
 * State is lifted here so both the canvas and simulation engine
 * have access to nodes and edges.
 */
...
function AppInner() {
  ...
  // Toggle simulation from the header button
